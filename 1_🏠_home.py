...
if "data" not in st.session_state:
    ...
    #acrescentar colunas de Rank considerando a classificação dos melhores jogadores
...
st.sidebar.markdown("Desenvolvido por [Josué Melo](https://www.linkedin.com/in/josu%C3%A9-suman-2b9351181/)")
